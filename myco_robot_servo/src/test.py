...
class  test():
    def __init__(self):
        ...
        self.myco_servoPose = rospy.Publisher("/servo_server/delta_twist_cmds", TwistStamped, queue_size=10)
        self.myco_servoJoint = rospy.Publisher("/servo_server/delta_joint_cmds", JointJog, queue_size=10)
    ...
    def servo_movePose(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.myco_servoPose.publish(self.servo_Pose)
            self.rate.sleep()


    def servo_moveJoint(self):
        
        self.servo_Joint.joint_names = ['myco_joint1','myco_joint2','myco_joint3','myco_joint4','myco_joint5','myco_joint6']
        ...
        while not rospy.is_shutdown():
            ...
            self.myco_servoJoint.publish(self.servo_Joint)
            self.rate.sleep()
