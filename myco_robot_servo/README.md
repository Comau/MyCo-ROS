...
* **roslaunch myco_robot_servo start_moveit_servo.launch**  

### Subscribed Topics 
* **/servo_server/delta_twist_cmds**  
令机械臂末端往x/y/z方向按照一定速度持续运动  
example: servo_movePose() in myco_robot_servo/src/test.py

* **/servo_server/delta_joint_cmds**  
令机械臂各个关节往正/负运动方向按照一定速度持续运动  
example: servo_moveJoint() in myco_robot_servo/src/test.py
